...
TEST(AggFactorModelParamsTest, AggregateFactorModelParams_WithBootstrap_AllParams) {
    // True factors (T x r)
...
TEST(AggFactorModelParamsTest, AggregateFactorModelParams_MapOverSpecs_Succeeds) {
